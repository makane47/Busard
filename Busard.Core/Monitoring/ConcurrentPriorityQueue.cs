...
namespace Busard.Core.Monitoring
{
        ...
        where TKey : IComparable<TKey>
    {
        ...
        public virtual void Enqueue(TKey priority, TValue value)
        {
        ...
        public virtual void Enqueue(KeyValuePair<TKey, TValue> item)
        {
            lock (_syncLock)
            {
                _minHeap.Insert(item);
        ...
        private sealed class MinBinaryHeap
        {
            ...
            public void RemoveAt(TKey key)
            {
                ...
                _items.RemoveAll(item => item.Key.Equals(key));
            }
